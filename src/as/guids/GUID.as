package guids
{
    ...
    public class GUID 
    {
        ...
        public function set rawID(value:String):void
        {
            _raw = value;
        }

        public function get rawID():String
        {
            return _raw;
        }
        ...
        {
            var ret:String = rawID.substring(0, 8) + "-" + rawID.substring(8, 12) + "-" + rawID.substring(12, 16) + "-" + rawID.substring(16, 20) + "-" + rawID.substring(20, 32);
            return ret;
        }
    }
}